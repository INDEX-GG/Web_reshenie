        ...
        <TableBody>
          {data.result.map((item) => (
            <TableRowUI
              ...
              <TableCellUI>{item.abc_segment}</TableCellUI>
              <TableCellUI align="right">{item.sales_month}</TableCellUI>
              <TableCellUI align="right">{item.current_sales_fbo}</TableCellUI>
              <TableCellUI align="right">{item.current_sales_fbs}</TableCellUI>
